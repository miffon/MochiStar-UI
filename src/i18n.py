...
_ZH_TW = {
    ...
    "Leave blank to use the visual source name": "留空時使用畫面來源檔名",
    "Output file name contains characters that are not supported on every platform": "輸出檔名包含無法跨平台使用的字元",
    ...
    "Fit": "符合範圍",
    "Snap": "吸附",
    "Hold Alt or Option while dragging to temporarily bypass snapping": "拖曳時按住 Alt 或 Option 可暫時略過吸附",
    "Add Marker": "新增標記",
    "Remove Marker": "移除標記",
    "Choose a visual or audio track position for its sync marker": "在畫面或音訊軌選擇 sync marker 位置",
    "Play": "播放",
    "Pause": "暫停",
    "Stop": "停止",
    "Zoom Out": "縮小",
    "Zoom In": "放大",
    "Loop Off": "未循環",
    "Drop one file here": "拖放一個檔案到這裡",
    "Drop visual and audio sources into the timeline": "將畫面與音訊來源拖放到時間軸",
    "Build Preview": "建立預覽",
    "Cancel Preview": "取消預覽",
    "Building preview...": "正在建立預覽...",
    "Loading preview...": "正在載入預覽...",
    "Preview needs to be updated": "預覽需要更新",
    "Preview failed": "預覽失敗",
    "Preview Before": "預覽前段",
    "Preview After": "預覽後段",
    "Preview Memory Limit": "預覽記憶體上限",
    "Blocks": "區塊",
    "Auto": "自動",
    "Preview Cache Segment": "預覽快取區段",
    "Preview Lead-in Ratio": "預覽提前比例",
    "Maximum RAM used by completed preview segments": "已完成預覽區段可使用的最大 RAM",
    "Duration of each preview cache segment": "每個預覽快取區段的長度",
    "Fraction of one cache segment reserved before the playhead": "播放頭之前優先快取的區段比例",
    "Longer preview ranges take more time and use more RAM": "預覽範圍越長, 建立時間與 RAM 使用量越高",
    "Preview range must have a positive duration": "預覽範圍必須大於 0 秒",
    "Preview exceeded the 256 MiB memory limit": "預覽超過 256 MiB RAM 上限, 請縮短預覽範圍",
    "FFmpeg returned an empty preview": "FFmpeg 沒有產生預覽資料",
    "Replace Source": "替換來源",
    "Replace the current source in this track?": "要替換這條軌道目前的來源嗎?",
